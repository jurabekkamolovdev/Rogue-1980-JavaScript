    ...
    export class Player {
        ...
        getState() {
            return {
                ...
                inventory: this.inventory_.map(w => w.type),
                equippedWeapon: this.equippedWeapon_ ? this.equippedWeapon_.type : null
            };
        }
        ...
        static fromSave(data) {
            ...
            player.level_ = s.level;
            player.maxHealth_ = s.maxHealth;
            player.currentHealth_ = s.currentHealth;

            player.maxStrength_ = s.maxStrength;
            player.currentStrength_ = s.currentStrength;

            player.gold_ = s.gold;
            player.armor_ = s.armor;

            player.experience_ = s.experience;
            player.maxExperience_ = s.maxExperience;

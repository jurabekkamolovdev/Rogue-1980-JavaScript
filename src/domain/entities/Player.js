...
export class Player {
    ...
    constructor(x = 0, y = 0) {
        ...
        // Corridor uchun global koordinatalar
        this.globalX_ = 0;
        this.globalY_ = 0;
    ...
    get globalX() { return this.globalX_; }
    set globalX(value) { this.globalX_ = value; }
    
    get globalY() { return this.globalY_; }
    set globalY(value) { this.globalY_ = value; }
